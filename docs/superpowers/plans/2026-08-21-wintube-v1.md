...
*Deferred: needs secrets.json + a signed-in user; see README setup.*
...
- [ ] **Step 4: MANUAL VERIFICATION — the stage-0 questions**
*Deferred: needs secrets.json + a signed-in user; see README setup.*
...
- [ ] **Step 2: Build, run, MANUAL VERIFICATION**
*Deferred: needs secrets.json + a signed-in user; see README setup.*
